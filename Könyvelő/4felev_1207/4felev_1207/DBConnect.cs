...
namespace belepteto
{
    public class DBConnect
    {
        ...
        //Insert statement; itt adjuk meg a paramétereket az ügyfél táblamezők száma alapján
        public void Insert(string a, string b, string c, string d, string e)
        {
            string query = "INSERT INTO ugyfel (azon, nev, szulev, irszam, orsz) VALUES('" + a + "', '" + b + "', '" + c + "', '" + d + "', '" + e + "')";
        ...
        public void Insert(string a, string b, string c) // itt adjuk meg a befizetéshez a paramétereket
        {
            string query = "INSERT INTO befiz (azon, datum, osszeg) VALUES('" + a + "', '" + b + "', '" + c + "')";
        ...
        //Delete statement; adat törlés
        public void Delete(string a)
        {
            string query = "DELETE FROM ugyfel WHERE nev='" + a + "'";
        ...
        // CUSTOM SELECT
        /*public string MySelect(string target, string table)
        {
            ...
            if (OpenConnection())
            {
                ...
                if (dataReader.Read())
                {
                    seged = dataReader[target].ToString();
                }
        ...
        //Select statement; bekérjük a listboxba az adatokat
        public List<string>[] Select()
        {
            ...
            if (this.OpenConnection() == true)
            {
                ...
                {
                    list[0].Add(dataReader["azon"] + "");
                    list[1].Add(dataReader["nev"] + "");
                    list[2].Add(dataReader["szulev"] + "");
                    list[3].Add(dataReader["irszam"] + "");
                    list[4].Add(dataReader["orsz"] + "");
